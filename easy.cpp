//
// Created by zzang on 2017-06-09.
//
...
//shows the board when the game starts
easy::easy() {
    for (int a=0; a<8; a++) {
        cout<< "|";
        for (int b = 0; b < 8; b++)
...
void easy::mov(int a) {
    if (gg) {
        ...
        if (ggwho==2)
            cout << " You suck haha go suck your fingers!!!" << endl;
        else
